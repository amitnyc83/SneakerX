...
testuser1 = User.create!(username: "testuser1", password:'password', name:"Jordan1", type:'Customer')
testuser2 = User.create!(username: "testuser2", password:'password', name:"Jordan2", type:'Seller')
